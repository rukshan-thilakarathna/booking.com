...
<div class="col-12 rik_login" style="position: relative;">
...
<a href="/" style="   background: #ffffff;
    ...
    position: absolute;
    z-index: 4;
    right: 16px;"><img src="{{asset('web/img/home-button.png')}}" style="width: 40px;"></a>
    ...
    align-items: center;
">
                    <div class="container-md col-8" style="background:url('http://localhost:8000/web/img/69ca67f002.jpg');background-size: cover;background-position: center;height: 100vh;">
                    </div>

...
<div class="container-fluid" data-controller="@yield('controller')" @yield('controller-data')>
    ...
    <div class="row justify-content-center d-md-flex h-100">
        ...
        <div class="col-xxl col-xl-9 col-12 rik_login" style="position: relative;">
        <a href="/" style="
  background: #ffffff;
    padding: 10px;
    font-size: 16px;
...
"><img src="{{asset('web/img/home-button.png')}}" style="width: 40px;"></a>
            ...
            <div class="container-md col-8" style=" background:url('{{asset('web/img/69ca67f002.jpg')}}');background-size: cover;    background-position: center;">

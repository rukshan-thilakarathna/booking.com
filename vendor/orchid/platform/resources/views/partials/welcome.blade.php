 <div class="bg-white rounded-top shadow-sm mb-4 rounded-bottom">
    ...
    @if(Auth::user()->profile_verified == 0)
        ...
        <div style="display: flex;align-items: center;">
            ...
            <div>
                <h1>Unverified {{ Auth::user()->role == 'user' ? 'Guest' : (Auth::user()->role == 'property-owner' ? 'Host' : 'Admin') }} </h1>
    ...
    @else
        ...
        <div style="display: flex;align-items: center;">
            <iframe style="width: 430px;height: 430px;" src="https://lottie.host/embed/21770f04-20bc-4b5a-b0ec-84d889748a23/YF1vgFyhzp.json"></iframe>
            <div>
                <h1>verified {{ Auth::user()->role == 'user' ? 'Guest' : (Auth::user()->role == 'property-owner' ? 'Host' : 'Admin') }} </h1>
